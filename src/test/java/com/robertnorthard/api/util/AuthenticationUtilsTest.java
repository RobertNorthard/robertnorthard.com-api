...
public class AuthenticationUtilsTest {
    ...
    /**
     * Test of base64Decode method, of class AuthenticationUtils.
     */
    @Test(expected = IllegalArgumentException.class)
    public void testBase64Decode() {
        String result = AuthenticationUtils.base64Decode(null);
        fail("Expected Illegal Argument Exception");
    }
     ...
     */
    @Test
    public void testBase64Decode2() {
        String result = AuthenticationUtils.base64Decode("cGFzc3dvcmQ=");
